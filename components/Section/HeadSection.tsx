    ...
    <section className="px-3 lg:w-[80%] mx-auto flex flex-col xl:flex-row">
      <div className="w-full flex items-center justify-center">
        <div className="flex flex-col   max-xl:text-center xl:items-start justify-center gap-y-4 lg:gap-y-6 w-full lg:w-[70%] text-texts ">
          ...
          <p className="max-md:text-center text-base">
          ...
          <p className="max-md:text-center text-base">
            ...
            this highly rated school here in Gwarimpa. ACCE is clearly a school
            where they the desire to learn is contagious and students of all
            ability flourish because everyone works hard to create a learning
      ...
      <div className="w-full max-xl:mt-8">
        <div className=" mx-auto w-[90%] h-[500px] lg:h-[684px] lg:w-[566px] relative ">
          <Image src={image} alt="teacherimage" fill className="object-cover" />
        </div>
      </div>
    </section>
  );
